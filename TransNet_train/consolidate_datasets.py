...
BBC_mp4_files = "raw_data/BBCDataset/*.mp4"
BBC_txt_files = "raw_data/BBCDataset/annotations/shots/"
BBC_target_dir = "consolidated/BBCDataset"
os.makedirs(BBC_target_dir, exist_ok=True)

RAI_mp4_files = "raw_data/RAIDataset/*.mp4"
RAI_txt_files = "raw_data/RAIDataset/labels/"
RAI_target_dir = "consolidated/RAIDataset"
os.makedirs(RAI_target_dir, exist_ok=True)

CLIPSHOTS_TRN_mp4_files = "raw_data/ClipShots/videos/train/*.mp4"
CLIPSHOTS_TRN_txt_files = "raw_data/ClipShots/annotations/train.json"
CLIPSHOTS_TRN_target_dir = "consolidated/ClipShotsTrain"
os.makedirs(CLIPSHOTS_TRN_target_dir, exist_ok=True)

CLIPSHOTS_TST_mp4_files = "raw_data/ClipShots/videos/test/*.mp4"
CLIPSHOTS_TST_txt_files = "raw_data/ClipShots/annotations/test.json"
CLIPSHOTS_TST_target_dir = "consolidated/ClipShotsTest"
os.makedirs(CLIPSHOTS_TST_target_dir, exist_ok=True)

CLIPSHOTS_GRD_mp4_files = "raw_data/ClipShots/videos/only_gradual/*.mp4"
CLIPSHOTS_GRD_txt_files = "raw_data/ClipShots/annotations/only_gradual.json"
...
for fn in tqdm(glob.glob(RAI_mp4_files)):
    ...
    gt_fn = os.path.join(RAI_txt_files, "scenes_" + fn_idx + ".txt")
